...
%define bigdecimal_version 1.2.0
%define io_console_version 0.4.2
%define json_version       1.7.7
%define minitest_version   4.3.2
%define psych_version      2.0.0
%define rake_version       0.9.6
%define rdoc_version       4.0.0
%define test_unit_version  2.0.0.0

%define rubygems_version   1.8.23

%define ruby_abi           2.0.0
%define ruby_archive %{name}-%{ruby_version}-p%{patchlevel}

Source: http://ftp.ruby-lang.org/pub/ruby/1.9/%{ruby_archive}.tar.gz
